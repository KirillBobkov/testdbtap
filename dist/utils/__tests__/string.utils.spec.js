import { camelize, capitalize, dasherize, decapitalize, getCapitalLetters, pluralize2, pluralize3, randomId, split, } from '../string.utils';
describe('string.utils', () => {
    describe('getCapitalLetters', () => {
        it('should return only capital letters from source string', () => {
            const shortTitleDynamicMomentumIndex = getCapitalLetters('Dynamic Momentum Index');
            const shortTitleDMI = getCapitalLetters('DMI');
            expect(shortTitleDynamicMomentumIndex).toBe('DMI');
            expect(shortTitleDMI).toBe('DMI');
        });
    });
    describe('dasherize', () => {
    ...
    describe('split', () => {
        it('should return string if no substring passed', () => {
            ...
            const result = split(string, void 0);
