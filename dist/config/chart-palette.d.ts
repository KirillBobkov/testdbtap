import { ChartPaletteLight } from './theme/chart-palette-light';
import { ChartPaletteDark } from './theme/chart-palette-dark';
export type ChartPalette = ChartPaletteLight | ChartPaletteDark;
export declare const DEFAULT_CHART_PALETTE: {
    light: {
 ...
 * @doc-tags styling
 */
export declare function mapPaletteToCssString(palette: ChartPalette): string;
