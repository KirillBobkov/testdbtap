...
const elliottCorrectionWaveLens = Lens.fromPath();
const elliottCorrectionWaveKeyPoints = elliottCorrectionWaveLens(['keyPoints']);
export const ElliottCorrectionWaveSettings = memo((props) => {
    ...
    const updateCoordinates = useCallback((keyPoints) => createHandler(elliottCorrectionWaveKeyPoints, keyPoints), [createHandler]);
