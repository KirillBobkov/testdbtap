...
const infoLineLens = Lens.fromPath();
const infoLineKeyPoints = infoLineLens(['keyPoints']);
export const InfoLineSettings = memo((props) => {
    ...
    const updateCoordinatesHandler = useCallback((value) => createHandler(infoLineKeyPoints, value), [createHandler]);
