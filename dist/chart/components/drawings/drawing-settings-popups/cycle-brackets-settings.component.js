...
const cycleBracketsLens = Lens.fromPath();
const keyPointsLens = cycleBracketsLens(['keyPoints']);
export const CycleBracketsSettings = memo((props) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(DrawingSettingsSection, { title: coordinatesSectionDict.title },
            React.createElement(DateCoordinatesGroup, { value: value.keyPoints, onValueChange: updateCoordinates, instrument: instrument, drawingsDict: drawingsDict, currentTimezone: currentTimezone, withPrice: true, updateAllPointsPrice: true })),
