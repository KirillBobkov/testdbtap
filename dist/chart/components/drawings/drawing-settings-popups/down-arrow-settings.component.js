...
const downArrowLens = Lens.fromPath();
const keyPointsLens = downArrowLens(['keyPoints']);
export const DownArrowSettings = memo((props) => {
    const { value, onValueChange, palette, currentTimezone, instrument, drawingsDict } = props;
